...
A játék egy asztali analóg számítógépre készült el, és egy oszcilloszkópot használt a megjelenítésre, mely \aref{fig_2/tennisfortwo}. ábrán látható.  
...
A játék az 1981-ben kiadott Donkey Kong volt, ahol a ma is híres Mario karakterével kellett megmenteni a bajbajutott lányt, a játékból egy jelenet \aref{fig_2/donkey_kong} ábrán tekinthető meg. 
...
%sony xperia play / mobil kontroller
...
\Aref{fig_2/pokemongoabra}. ábra jobb oldali képén látható módon a pontos pozíciónkat megjeleníti a térképen, ami a valós világ útjaira, épületeire alapszik. 
Annyiban viszont eltér, hogy a játék egyes elemeit például a pokémonokat (kitalált állatszerű lények) a virtuális világban a térképre helyezi, majd a felhasználónak a való világban fizikailag oda kell jutnia hozzá, hogy elkaphassa, amely \aref{fig_2/pokemongoabra}. ábra bal oldali képén látható. 
...
Minden játékoshoz tartozik egy karakter, aki fölött rendelkezhet, illetve a karakterlapján vezetheti a statisztikákat és jellemzőket, amint \aref{fig_2/dungeon_and_dragons_character_sheet}. ábrám is látható. 
