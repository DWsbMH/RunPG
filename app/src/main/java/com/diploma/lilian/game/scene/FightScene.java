...
public class FightScene extends GameScene implements OnCollisionListener {
    ...
    public FightScene(Context context, int surfaceWidth, int surfaceHeight, Player player, Enemy enemy) {
...
/*
            player.getSprite().moveInPlot(surfaceWidth / 4, surfaceWidth / 4, 0);
            vp.addElement(player.getSprite(), MAIN_LAYER);
            player.getSprite().moveInIso(1, 0, 0);


            enemy.getSprite().moveInPlot(surfaceWidth * 3 / 4, surfaceHeight * 3 / 4, 0);
            vp.addElement(enemy.getSprite(), MAIN_LAYER);
            enemy.getSprite().moveInIso(1, 0, 0);
...
*/
            ...
            try {
                ...
                mushroom = SpriteDataParser.loadIsoSprite(context.getAssets().open("sprites/" + enemy.getSprite().getName() + ".xml"));
