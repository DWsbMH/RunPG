...
//
//    private final static String CLIENT_ID = "8d51cb235e244c438deecb769c9fe53d";
//    private final static String CLIENT_SECRET = "7b02945e1c7244e8bf4eea7e3ff1cd71";
...
//                            double totalWalkingDistanceKiloMeters = totalWalkingDistanceMeters/1000;
//                            displayTotalWalkingDistance(totalWalkingDistanceKiloMeters);
//                            return;
//                        }
//                    }
//                }
...
//        final String milesWalkedMessage = (totalWalkingDistanceMiles < 1) ? "0 kilometers?, You get no respect, Start walking already!!!" :
//                String.format("Cool, You have walked %.2f kilometers so far.", totalWalkingDistanceMiles);
//
...
//    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OAuth20Service runkeeperService = new ProviderFactory(this,"Runkeeper").create().getOAuthService();
...
//            @Override
//            public boolean shouldOverrideUrlLoading(WebView view, String url) {
//                if (url.startsWith(GraphConstants.REDIRECT_URI)) {
//                    final String authCode = Uri.parse(url).getQueryParameter("code");
//                    webView.setVisibility(View.GONE);
//                    getAccessToken(authCode);
//                    return true;
...
//                    String accessToken = json.getString("access_token");
//
//                    RunkeeperService runkeeperService = new RunkeeperService(accessToken);
//                    Log.e("Toast", runkeeperService.fitnessActivityWrapper.getFitnessActivityFeed().getSize().toString());
//
//                } catch (Exception e) {
//                    displayToast("Exception occured:(");
//                    e.printStackTrace();
